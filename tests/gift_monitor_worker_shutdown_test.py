...
def test_shutdown_cleans_pending_files():
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        result = candidate_queue.enqueue(
            source_path
        )
...
if __name__ == "__main__":
    test_shutdown_cleans_pending_files()

    print(
        "PASS: gift monitor shutdown cleanup"
    )
